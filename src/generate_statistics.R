...
#######################################
df <- read.csv("/home/james/CodingProjects/ExplainPetBERT/models/shap_vals_instance_df.csv")
...
df <- df %>% filter(method != "All-Text (Unimodal)")
...
# Produce charts for overall dataset
# Text FI - Tabular FI
####################################################
# By text model
p <- ggbetweenstats(
...
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/pdfs/text_tab_mod_vet.pdf", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)

# save as jpeg
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/jpegs/text_tab_mod_vet.jpeg", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
...
# Save the plot to a PDF file
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/pdfs/text_tab_comb_vet.pdf", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
# print(p)
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/jpegs/text_tab_comb_vet.jpeg", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
  ...
  tryCatch(
    {
      ...
      p <- ggbetweenstats(
        ...
        title = "Are Text or Tabular Features Assigned More Importance?,
Difference in Median Feature Importance (SHAP), by Text Model",
        caption = paste("Dataset: vet Combination Method: ", cm),
      )

      # Save the plot to a PDF file
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/pdfs/text_tab_mod_vet_", cm, ".pdf", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)

      # save as jpeg
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/jpegs/text_tab_mod_vet_", cm, ".jpeg", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)
    },
    error = function(e) {
      print(paste("Error occurred for Dataset:vetCombination Method:", cm))
  ...
  tryCatch(
    {
      ...
      p <- ggbetweenstats(
        ...
        title = "Are Text or Tabular Features Assigned More Importance?,
Difference in Median Feature Importance (SHAP), by Combination Method",
        caption = paste("Dataset: vetText Model: ", tm),
      )

      # Save the plot to a PDF file
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/pdfs/text_tab_method_vet_", tm, ".pdf", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)

      # save as jpeg
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/jpegs/indiv_text_tab_method_vet_", tm, ".jpeg", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)
    },
    error = function(e) {
      print(paste("Error occurred for Dataset:vetText Model:", tm))
      # print(e) # Print the error message for debugging
    }
  )
}, unique(df$text_model))

# Produce charts for overall dataset
# Text record - Tabular FI
####################################################
# By text model
p <- ggbetweenstats(
  data = df,
  ...
  palette = "default_jco",
  pairwise.display = "ns",
  ylab = "Text Record - Median(Tabular FI)",
  xlab = "Text Model",
  title = "Are Tabular features or the Text Record Assigned More Importance?,
Text Record Feature Importance - Median Tabular Feature Importance (SHAP),
by Text Model",
  # caption = paste("Dataset: ", caption),
)

# Save the plot to a PDF file
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/pdfs/textrecord_tab_mod_vet.pdf", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)

# save as jpeg
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/jpegs/textrecord_tab_mod_vet.jpeg", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
...
# Save the plot to a PDF file
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/pdfs/textrecord_tab_comb_vet.pdf", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
# print(p)
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/jpegs/textrecord_tab_comb_vet.jpeg", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
...
by Text Model",
      ...
      # Save the plot to a PDF file
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/pdfs/textrecord_tab_mod_vet_", cm, ".pdf", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)

      # save as jpeg
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/jpegs/textrecord_tab_mod_vet_", cm, ".jpeg", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)
    },
    error = function(e) {
      print(paste("Error occurred for Dataset:vetCombination Method:", cm))
...
by Combination Method",
      ...
      # Save the plot to a PDF file
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/pdfs/textrecord_tab_method_vet_", tm, ".pdf", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)

      # save as jpeg
      file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/individual/jpegs/textrecord_tab_method_vet_", tm, ".jpeg", sep = "")
      ggsave(file = file_name, plot = p, width = 8.5, height = 5)
    },
    error = function(e) {
      print(paste("Error occurred for Dataset:vetText Model:", tm))
...
# Save the plot to a PDF file
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/pdfs/ft_order_mod_vet.pdf", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
# print(p)
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/jpegs/ft_order_mod_vet.jpeg", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
...
# Save the plot to a PDF file
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/pdfs/ft_order_comb_vet.pdf", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
# print(p)
file_name <- paste("/home/james/CodingProjects/ExplainPetBERT/images/R_plots/jpegs/ft_order_comb_vet.jpeg", sep = "")
ggsave(file = file_name, plot = p, width = 8.5, height = 5)
